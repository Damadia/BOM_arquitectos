...
<body>
	...
	<div class="buttonBox">
		<button class="buttonProject left"><i class="fa-solid fa-arrow-left fa-xl"></i></button>
		<div class="projectsCardBox">
			<?php
				include('showProjects.php');
			?>
		</div>
		<button class="buttonProject right"><i class="fa-solid fa-arrow-left fa-flip-horizontal fa-xl"></i></button>
	</div>
	

	<?php 
		if (isset($_SESSION['email']) && $_SESSION['tier'] > 0)
			echo "<form action='insertProject.php' method='Get'>
					<input class='hyStyle' type='submit' value='Insertar nuevo proyecto'>
				</form>";
	?>
...
<script src="js/moveProBox.js"></script>
</body>
</html>