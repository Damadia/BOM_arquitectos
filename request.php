...
<head>
	...
	<title>BOM - Solicitudes </title>
	<link rel="stylesheet" href="css/bootstrap.min.css">
	<link rel="stylesheet" href="css/generalStyle.css">
	<link rel="stylesheet" href="css/requestLayaout.css">
...
<body>
	...
	<div class="bigContainer">
		<h2 class="requestTitle"> Solicitudes </h2>
		<?php
			if (isset($_SESSION['tier']))
			{
				if($_SESSION['tier'] == 0)
					include('seeRequestFromUser.php');
				else
					include('seeRequestFromAdministrator.php');	
			}
		?>
