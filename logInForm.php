...
<body>
	...
	<div class="bigFormContainer">
		<form action="logIn.php" id="formForLogIn" method="post" class="form1Style">
			<p class="TitleForm">Ingresa tus datos</p>
			<div class="fields">	
				...
				<p class="centerField">
					<input class="hyStyle" type="submit" value="Iniciar sesión">
				</p>
			</div>	
